...
const KEYWORD_QUERIES: Query[] = [
  { query: "Searcher", expectedFiles: ["crates/searcher/src/searcher/mod.rs"], expectedNames: ["Searcher"] },
  { query: "SearcherBuilder", expectedFiles: ["crates/searcher/src/searcher/mod.rs"], expectedNames: ["SearcherBuilder"] },
  { query: "RegexMatcher", expectedFiles: ["crates/regex/src/matcher.rs"], expectedNames: ["RegexMatcher"] },
  { query: "Standard printer", expectedFiles: ["crates/printer/src/standard.rs"], expectedNames: ["Standard"] },
  { query: "JSON printer", expectedFiles: ["crates/printer/src/json.rs"], expectedNames: ["JSON"] },
  { query: "Summary printer", expectedFiles: ["crates/printer/src/summary.rs"], expectedNames: ["Summary"] },
  { query: "WalkBuilder", expectedFiles: ["crates/ignore/src/walk.rs"], expectedNames: ["WalkBuilder"] },
  { query: "DirEntry", expectedFiles: ["crates/ignore/src/walk.rs", "crates/ignore/src/dir.rs"], expectedNames: ["DirEntry"] },
  { query: "GlobSet", expectedFiles: ["crates/globset/src/lib.rs"], expectedNames: ["GlobSet"] },
  { query: "LineStep", expectedFiles: ["crates/searcher/src/lines.rs", "crates/searcher/src/line_buffer.rs"], expectedNames: ["LineStep"] },
  { query: "BinaryDetection", expectedFiles: ["crates/searcher/src/searcher/mod.rs"], expectedNames: ["BinaryDetection"] },
  { query: "MmapChoice", expectedFiles: ["crates/searcher/src/searcher/mmap.rs"], expectedNames: ["MmapChoice"] },
  ...
  { query: "MultiLine", expectedFiles: ["crates/searcher/src/searcher/glue.rs"], expectedNames: ["MultiLine"] },
]
...
async function runFtsTest(dbPath: string, ftsColumns: string, indexSql: string, label: string) {
  ...
  // Run keyword queries
  let top1 = 0, top3 = 0, totalLatency = 0
...
async function main() {
  ...
  await runFtsTest(dbPath, "name, signature, snippet",
  ...
  await runFtsTest(dbPath, "name, signature",
