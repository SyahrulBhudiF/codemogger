...
async function main() {
  ...
  console.log(`Method 1 (prepared + txn): ${method1}ms for ${N} inserts = ${(method1/N).toFixed(1)}ms/insert`)
  ...
  console.log(`Method 2 (exec multi-stmt): ${method2}ms for ${N} inserts = ${(method2/N).toFixed(1)}ms/insert`)
  ...
  console.log(`Method 3 (multi-row VALUES): ${method3}ms for ${N} inserts = ${(method3/N).toFixed(1)}ms/insert`)
